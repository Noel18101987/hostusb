...
(* X_INTERFACE_INFO = "xilinx.com:interface:pcie2_cfg_interrupt:1.0 pcie2_cfg_interrupt ltrenable" *)
output wire cfg_interrupt_ltrenable;
...
output wire pcie_drp_rdy;
  ...
  pcie_7x_0_pcie2_top #(
    ...
    .c_ltr_cap_id("000"),
    .c_ltr_cap_ver("000"),
    .c_ltr_max_snoop_latency_scale("000"),
    .c_ltr_max_snoop_latency_value("000"),
    .c_ltr_max_no_snoop_latency_scale("000"),
    .c_ltr_max_no_snoop_latency_value("000"),
    .c_msix_cap_on("FALSE"),
    .c_msix_next_ptr("00"),
