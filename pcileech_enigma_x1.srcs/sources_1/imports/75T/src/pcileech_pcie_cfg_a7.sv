...
module pcileech_pcie_cfg_a7(
    ...
    wire       [31:0] MWR64_DW3  = {msi_address[31:2], 2'b0};
    wire       [31:0] MWR64_DW4  = {msi_vector};
    ...
    end else if (i_msix_req) begin    // <--- Usamos la señal de petición real
        msix_has_data <= 1'b1;
        // Reutilizamos la lógica original que ya construye el TLP correctamente
