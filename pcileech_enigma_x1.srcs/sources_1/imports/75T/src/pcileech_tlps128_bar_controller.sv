...
always @(posedge clk) begin
    if (rst) begin
        ...
        for (i = 0; i < 8; i = i + 1) begin
            ...
            msix_ctrl_table[i] <= 32'h00000001; // Enmascarados por defecto
        end
        ...
        // --- Lógica de Interrupción basada en Timbre (Doorbell) ---
        msix_req <= 1'b0; // Por defecto, la petición de interrupción está desactivada.
        
        // Comprueba si hay una escritura válida en la dirección del Timbre 0 (offset 0x600).
        if (dwr_valid && (((dwr_addr - (base_address_register & 32'hFFFFE000)) & 32'h1FFF) == 16'h0600)) begin
            // El driver ha tocado el timbre. Generamos la petición de interrupción.
            msix_req <= 1'b1;
